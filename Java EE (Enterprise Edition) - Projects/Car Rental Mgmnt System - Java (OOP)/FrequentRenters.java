...
public class FrequentRenters extends Renters
{
	FrequentRenters(String name,String email,String phone,String address)
	{
	...
	public double rents(double distance,double cost)
	{
		...
		System.out.println("You got Discount : Rs "+0.1*cost);
		double discounts=cost-(0.1*cost);// provide 10% discount on total rental cost
